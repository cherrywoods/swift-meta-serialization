...
public protocol MetaSupplier {
    ...
    /**
     ...
     You may not call Encodables `encode(to:)` in this method directly, neighter one of the container methods.
     ...
     - Parameter encoder: The encoder that requests the wrap. You should use this encoder if you need to encode values yourself inside wrap or to get the current coding path (this an array of coding keys visited up to value in the order they were visited taken up to `value`). The coding path is ment to be used in errors you may throw (e.g. `EncodingError`).
